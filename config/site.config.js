...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'Cuiyangeng@vkvxt.onmicrosoft.com',
  ...
  protectedRoutes: ['/🌞 Private folder/Public/u-need-a-password', '/🥟 Some test files/Protected route'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:qq18005895@gmail.com',
